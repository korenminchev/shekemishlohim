...
var order_delivery_1 = require("./order_delivery");
...
var UNRECOGNIZED_COMMAND = "\u05E1\u05D5\u05E8\u05D9, \u05DC\u05D0 \u05D4\u05D1\u05E0\u05EA\u05D9\uD83D\uDE05 \u05D0\u05E4\u05E9\u05E8 \u05DC\u05E9\u05DC\u05D5\u05D7 \u05DC\u05D9 \"\u05E2\u05D6\u05E8\u05D4\" \u05D1\u05E9\u05D1\u05D9\u05DC \u05DC\u05E8\u05D0\u05D5\u05EA \u05D0\u05EA \u05DB\u05DC \u05D4\u05D0\u05D5\u05E6\u05D9\u05D5\u05EA\u2139\uFE0F";
    ...
    WelcomeState.prototype.handle = function (message, user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("Handling message in Welcome state: ".concat(user_id, " - ").concat(message.body));
                        return [4 /*yield*/, this.db.getUser(user_id).then(function (user) {
                                // response = new StateResponse(this, new MessageResponse(`היי ${user.name} :)\n${MORE_INFO}`));
                                switch (message.body) {
                                    case "בשקם":
                                    case "ש":
                                        response = new state_response_1.StateResponse(_this, new message_response_1.MessageResponse("עדיין לא פיתחתי את הצד של השקם"));
                                        break;
                                    case "משלוח":
                                    case "מ":
                                        response = new state_response_1.StateResponse(new order_delivery_1.OrderDeliveryState(_this.db), new message_response_1.MessageResponse(null));
                                        break;
                                    case "עזרה":
                                        response = new state_response_1.StateResponse(_this, new message_response_1.MessageResponse("תפריט עזרה"));
                                        break;
                                    default:
                                        response = new state_response_1.StateResponse(_this, new message_response_1.MessageResponse(UNRECOGNIZED_COMMAND));
                                }
                            })["catch"](function () {
                                _this.db.increaseUniqueMessagesCount();
